...
describe('Component Tests', () => {
    describe('EmployeeTimesheet Management Detail Component', () => {
        ...
        const route = ({ data: of({ employeeTimesheet: new EmployeeTimesheet(123) }) } as any) as ActivatedRoute;
        ...
        describe('OnInit', () => {
            it('Should call load all on init', () => {
                ...
                // THEN
                expect(comp.employeeTimesheet).toEqual(jasmine.objectContaining({ id: 123 }));
            });
        });
    });
});
