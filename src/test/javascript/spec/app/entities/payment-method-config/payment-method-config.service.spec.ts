...
describe('Service Tests', () => {
    describe('PaymentMethodConfig Service', () => {
        ...
        describe('Service methods', async () => {
            ...
            it('should create a PaymentMethodConfig', async () => {
                ...
                service
                    .create(new PaymentMethodConfig(null))
                    .pipe(take(1))
            ...
            it('should update a PaymentMethodConfig', async () => {
                const returnedFromService = Object.assign(
                    {
                        key: 'BBBBBB',
                        value: 'BBBBBB',
            ...
            it('should return a list of PaymentMethodConfig', async () => {
                const returnedFromService = Object.assign(
                    {
                        key: 'BBBBBB',
                        value: 'BBBBBB',
            ...
            it('should delete a PaymentMethodConfig', async () => {
