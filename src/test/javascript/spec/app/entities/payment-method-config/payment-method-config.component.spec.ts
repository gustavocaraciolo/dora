...
import { PaymentMethodConfigComponent } from 'app/entities/payment-method-config/payment-method-config.component';
...
describe('Component Tests', () => {
    describe('PaymentMethodConfig Management Component', () => {
        let comp: PaymentMethodConfigComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(PaymentMethodConfigComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            spyOn(service, 'query').and.returnValue(
                of(
                    new HttpResponse({
                        body: [new PaymentMethodConfig(123)],
                        headers
                    })
                )
            );
            ...
            expect(comp.paymentMethodConfigs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
