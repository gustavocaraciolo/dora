...
import { IPayment, Payment, PaymentStatus } from 'app/shared/model/payment.model';
...
describe('Service Tests', () => {
    describe('Payment Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Payment(0, currentDate, 'AAAAAAA', 0, PaymentStatus.PENDING, 'AAAAAAA', 'AAAAAAA');
        });
