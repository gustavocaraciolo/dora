...
import { SectionTableComponent } from 'app/entities/section-table/section-table.component';
...
describe('Component Tests', () => {
    describe('SectionTable Management Component', () => {
        let comp: SectionTableComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(SectionTableComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.sectionTables[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
