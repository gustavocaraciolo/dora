...
import { ShopSectionComponent } from 'app/entities/shop-section/shop-section.component';
...
describe('Component Tests', () => {
    describe('ShopSection Management Component', () => {
        let comp: ShopSectionComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ShopSectionComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.shopSections[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
