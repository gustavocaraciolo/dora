...
import { ProductExtraComponent } from 'app/entities/product-extra/product-extra.component';
...
describe('Component Tests', () => {
    describe('ProductExtra Management Component', () => {
        let comp: ProductExtraComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ProductExtraComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.productExtras[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
