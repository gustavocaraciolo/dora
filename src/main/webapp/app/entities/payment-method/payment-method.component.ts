...
export class PaymentMethodComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.paymentMethodService
                ...
                .subscribe(
                    (res: HttpResponse<IPaymentMethod[]>) => this.paginatePaymentMethods(res.body, res.headers),
    ...
    protected paginatePaymentMethods(data: IPaymentMethod[], headers: HttpHeaders) {
