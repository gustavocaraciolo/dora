...
export class EmployeeTimesheetComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.employeeTimesheetService
                ...
                .subscribe(
                    (res: HttpResponse<IEmployeeTimesheet[]>) => this.paginateEmployeeTimesheets(res.body, res.headers),
    ...
    ngOnInit() {
        ...
        this.registerChangeInEmployeeTimesheets();
    }
    ...
    registerChangeInEmployeeTimesheets() {
        this.eventSubscriber = this.eventManager.subscribe('employeeTimesheetListModification', response => this.loadAll());
    }
    ...
    protected paginateEmployeeTimesheets(data: IEmployeeTimesheet[], headers: HttpHeaders) {
        this.links = this.parseLinks.parse(headers.get('link'));
        this.totalItems = parseInt(headers.get('X-Total-Count'), 10);
        this.employeeTimesheets = data;
    }
