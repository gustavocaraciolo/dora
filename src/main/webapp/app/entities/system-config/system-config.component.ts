...
export class SystemConfigComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.systemConfigService
                ...
                .subscribe(
                    (res: HttpResponse<ISystemConfig[]>) => this.paginateSystemConfigs(res.body, res.headers),
    ...
    trackId(index: number, item: ISystemConfig) {
        return item.id;
    }
    ...
    protected paginateSystemConfigs(data: ISystemConfig[], headers: HttpHeaders) {
